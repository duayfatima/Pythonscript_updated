...
from_date = (datetime.now()- timedelta(days=91)).strftime('%Y-%m-%dT00:00:00.000Z')
to_date = (datetime.now()- timedelta(days=91)).strftime('%Y-%m-%dT23:59:59.999Z')
...
def main():
    ...
    request_data = {
        ...
        "Password": "AbcD@1234",
        #"dateFrom": "2023-04-01T00:00:00.000Z",
        #"dateTo": "2023-05-15T23:59:59.999Z",
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            for item in json_data[0]['Data']:
                query = ("INSERT INTO COURIER_M_AND_P_DATA (consignmentNumber, clientname, BookingDate, consignee, pcs, SERVICE, name, WEIGHT, pieces, serviceTypeName, orderRefNo, deliveryDate, receivedBy, ReceiptAmount, DESTINATION, RRSTATUS, RRPayable, CNApproved, paidon, PaymentMode, LocationName) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);")
