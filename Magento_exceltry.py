...
try:
    ...
    with SSHTunnelForwarder(
        ...
        set_keepalive=300  # Set the keepalive interval to 300 seconds
    ) as tunnel:
        ...
        # Set max_allowed_packet size globally
        query_set_max_packet = 'SET GLOBAL max_allowed_packet=67108864'
        with connection.cursor() as cursor:
            cursor.execute(query_set_max_packet)
            connection.commit()
