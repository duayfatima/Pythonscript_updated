...
with SSHTunnelForwarder(
    ...
    #query = "SELECT * FROM search_query WHERE num_results = 0 AND popularity > 100;"
    query = "SELECT COUNT(*) FROM search_query WHERE num_results = 0 AND popularity > 100 AND redirect IS NULL;"
    #query = "SELECT COUNT(*) FROM search_query WHERE num_results = 0 AND popularity > 100 AND redirect NOT NULL;"
