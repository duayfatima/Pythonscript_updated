...
#from_date = (datetime.utcnow() - timedelta(days=91)).strftime('%Y-%m-%d')
#to_date = (datetime.utcnow() - timedelta(days=91)).strftime('%Y-%m-%d')


# API URL
api_url = "http://new.leopardscod.com/webservice/trackBookedPacketGulAhmed"
api_params = {
    #"from_date": from_date,
    #"to_date": to_date,
...
if response.status_code == 200:
    ...
    for packet in packet_list:
        ...
        booked_packet_status = packet.get("booked_packet_status","")
        ...
        insert_query = """
            INSERT INTO COURIER_LEOPORD_DATA 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);
        """
